...
form.addEventListener('submit', function (event) {
  ...
  console.log(breed);
  var goodWithCats = event.target.cats.checked;
  console.log(goodWithCats);
  var goodWithDogs = event.target.dogs.checked;
  console.log(goodWithDogs);
  var goodWithKids = event.target.kids.checked;
  console.log(goodWithKids);
  var cat = new Cat(
    name,
    0,
    likes,
